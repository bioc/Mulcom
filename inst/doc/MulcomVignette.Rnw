...
@
The analysis yielded to 1555 significant genes; we performed the same analysis on Illumina dataset: 
with 763 significant genes, user can apply the function \emph{mulInt} to verify the overlap between differnt list of genes.
